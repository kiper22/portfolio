...
class Face:
    def __init__(self, directory):
        ...
        self.target_size = (160, 160) # size of input photos in FaceNet, if you have different size you need resize photo
        self.X, self.Y = [], []
...
faces = Face(directory=r"C:\Projekty\PracaInz\Data\Datasets\cfpw_celebs_to_train_svm")
...
np.savez_compressed('faces_embeddings_50_celebs.npz', EMBEDDED_X, Y)
...
with open('svm_model_160x160_50celebs.pkl', 'wb') as f:
    pickle.dump(model, f)
